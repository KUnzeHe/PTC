...
> 当前阶段：理论框架与数值验收方案已建立，代码和数值数据尚未开始落地  
> 最近更新：2026-07-30
...
原则：先确认体拓扑和中隙态，再优化局域峰或放大图。

## 9. 计划代码结构

当前尚未创建代码目录。实现时优先采用下面的职责划分；具体文件名应在选定语言和入口方式后固定。
...
正式入口、依赖版本、配置格式和命令应在首批代码建立后补入本节。
